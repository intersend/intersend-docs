...
# Overview - For Apps [Get your app listed on Intersend]
...
- [For existing Safe apps](https://intersend.mintlify.app/apps/privy)
- [For apps that are using Privy](https://intersend.mintlify.app/apps/privy)
- [For apps that are using Dynamic](https://intersend.mintlify.app/apps/dynamic)

### iFrame & Event Listeners

Intersend loads your app within an iframe, and sends/ expects events to:
...
Because of this, you need to **whitelist Intersend’s domain** so your site can be embedded in an iframe and to allow cross-domain communication.
...
We’ll add your project to the Intersend App Store so users can seamlessly discover and use your app.
